...
HD_PWD='C:/Users/Hp/Documents/Verilog/Calculator/Calculator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Basys3_Abacus_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Basys3_Abacus_Top.tcl
