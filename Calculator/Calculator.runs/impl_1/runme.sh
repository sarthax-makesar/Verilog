...
HD_PWD='C:/Users/Hp/Documents/Verilog/Calculator/Calculator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Basys3_Abacus_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Basys3_Abacus_Top.tcl -notrace
